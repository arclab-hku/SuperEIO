...
{
    ros::init(argc, argv, "supereio_ba");
    ros::NodeHandle n("~");
    ...
    ros::Subscriber sub_feature = n.subscribe("/event_detector/feature", 2000, feature_callback);
    ros::Subscriber sub_relo_points = n.subscribe("/loop_closure/match_points", 2000, relocalization_callback);

    ros::Subscriber gt_pose_sub_=n.subscribe("/mavros/vision_pose/pose", 0, &GTCallback);
